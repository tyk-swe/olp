...
use olp_storage::{
    AccessError, ConfigurationError, IdempotencyOutcome, PersistenceError, PgStore,
    SessionMaterial, SessionPrincipal, TeamError,
};
...
pub(super) struct RuntimeGenerationResponse {
...
pub(super) fn map_team(error: TeamError) -> Problem {
    match error {
