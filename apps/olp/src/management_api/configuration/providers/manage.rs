...
use olp_storage::{
    ...
    UpdateProvider, credential_aad, idempotency_fingerprint, idempotency_secret_digest,
};
...
fn provider_config(provider: &ProviderRecord) -> Result<ProviderConfig, String> {
