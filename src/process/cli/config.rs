...
use crate::http::cors::CorsAllowedOrigins;
use crate::http::proxy::TrustedProxyCidr;
use crate::http::public_origin::PublicOrigin;
use crate::http::request_admission::public::DEFAULT_MAX_IN_FLIGHT_INFERENCE_REQUESTS;
use crate::http::request_admission::public::DEFAULT_MAX_IN_FLIGHT_MANAGEMENT_REQUESTS;
use crate::http::request_admission::public::MAX_ADMISSION_CAPACITY;
...
pub(crate) enum Command {
    ...
    /// Initialize or migrate the 3.0 PostgreSQL schema and exit.
...
pub(crate) struct InternalPreStopArgs {
...
pub(crate) struct RuntimeAssetArgs {
    ...
    pub(crate) connector_config_file: Option<PathBuf>,
}
...
pub(crate) struct ServeArgs {
    ...
    pub(crate) observability_listen_addr: SocketAddr,
    ...
    pub(crate) http_max_in_flight_inference_requests: usize,
    ...
    pub(crate) http_max_in_flight_management_requests: usize,
    ...
    pub(crate) http_connection_max_age_seconds: u64,
    ...
    pub(crate) http_connection_drain_timeout_seconds: u64,
    #[arg(
        long,
    ...
    pub(crate) trusted_proxy_cidrs: TrustedProxyCidrs,
    ...
    pub(crate) gateway_cors_allowed_origins: CorsAllowedOrigins,
    #[command(flatten)]
    pub(crate) provider_egress: ProviderEgressArgs,
    #[command(flatten)]
    pub(crate) provider_response_limits: ProviderResponseLimitArgs,
    #[command(flatten)]
    pub(crate) body_limits: BodyLimitArgs,
...
pub(crate) struct TracingArgs {
    ...
    pub(crate) otlp_traces_endpoint: Option<String>,
    #[arg(long, env = "OLP_OTLP_HEADERS_FILE")]
    pub(crate) otlp_headers_file: Option<PathBuf>,
    #[arg(
        long,
    ...
    pub(crate) trace_propagate_upstream: bool,
    #[arg(
        long,
    ...
    pub(crate) trace_accept_inbound: bool,
}

#[derive(Clone, Debug, Args)]
pub(crate) struct BodyLimitArgs {
    ...
    pub(crate) http_max_json_body_bytes: usize,
    ...
    pub(crate) http_max_media_body_bytes: usize,
    ...
    pub(crate) http_max_inline_media_items: usize,
    ...
    pub(crate) http_max_inline_media_item_bytes: usize,
    ...
    pub(crate) http_max_inline_media_total_bytes: usize,
}

impl BodyLimitArgs {
    pub(crate) const fn limits(&self) -> BodyLimits {
        BodyLimits {
...
#[derive(Clone, Debug, Args)]
pub(crate) struct ProviderResponseLimitArgs {
    ...
    pub(crate) provider_max_event_bytes: usize,
}

impl ProviderResponseLimitArgs {
    pub(crate) fn limits(&self) -> Result<ResponseLimits, String> {
...
#[derive(Clone, Debug, Args)]
pub(crate) struct ProviderEgressArgs {
    ...
    pub(crate) provider_egress_allow_cidrs: ProviderEgressAllowCidrs,
    ...
    pub(crate) provider_egress_allow_http_hosts: ProviderEgressAllowHttpHosts,
}
...
pub(crate) struct DoctorArgs {
    #[command(flatten)]
    pub(crate) persistence: PersistenceArgs,
    #[command(flatten)]
    pub(crate) assets: RuntimeAssetArgs,
    #[arg(long, env = "OLP_MASTER_KEY_FILE")]
    pub(crate) master_key_file: PathBuf,
    #[arg(long, env = "OLP_AUTH_HMAC_KEY_FILE")]
    pub(crate) auth_hmac_key_file: PathBuf,
    #[command(flatten)]
    pub(crate) provider_egress: ProviderEgressArgs,
}

#[derive(Clone, Debug, Args)]
pub(crate) struct MasterKeyArgs {
    #[command(flatten)]
    pub(crate) database: DatabaseArgs,
    #[arg(long, env = "OLP_MASTER_KEY_FILE")]
    pub(crate) master_key_file: PathBuf,
    #[command(subcommand)]
    pub(crate) action: MasterKeyAction,
}

#[derive(Clone, Debug, Subcommand)]
pub(crate) enum MasterKeyAction {
...
pub(crate) struct TrustedProxyCidrs(pub(crate) Vec<TrustedProxyCidr>);
...
impl std::str::FromStr for TrustedProxyCidrs {
    type Err = crate::http::proxy::TrustedProxyCidrParseError;
...
#[derive(Clone, Debug, Default)]
pub(crate) struct ProviderEgressAllowCidrs(pub(crate) Vec<IpNet>);
...
#[derive(Clone, Debug, Default)]
pub(crate) struct ProviderEgressAllowHttpHosts(pub(crate) Vec<String>);
