...
pub(crate) async fn health_probe() -> AppResult<()> {
...
mod tests {
    ...
    use crate::process::cli::health_probe::MAX_STATUS_LINE_BYTES;
    use crate::process::cli::health_probe::read_status_line;
    use crate::process::cli::health_probe::status_line_is_ready;
    use crate::process::cli::health_probe::write_request;
