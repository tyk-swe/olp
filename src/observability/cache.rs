...
use crate::observability::metrics::collect_metrics;
use crate::observability::readiness::HealthResponse;
use crate::observability::readiness::collect_readiness;
...
impl ObservabilityCache {
    ...
    pub(crate) fn metrics(&self) -> CachedMetrics {
        self.metrics
            .read()
...
pub(crate) fn snapshot_age_seconds(at: Option<Instant>, now: Instant) -> Option<u64> {
...
pub(crate) fn attach_snapshot_freshness(response: &mut Response, age: Option<u64>, fresh: bool) {
    let age = age
