...
use crate::observability::tracing::request::RequestConfig;
use crate::observability::tracing::request::TracedBody;
use crate::observability::tracing::request::extract_parent;
use crate::observability::tracing::request::request_span;
use crate::observability::tracing::request::trace_request_id;
...
fn request_span_callsite_is_allowlisted_and_omits_untrusted_request_id_content() {
    ...
    declared.sort();
    let mut expected = crate::inference::tracing::REQUEST_ATTRIBUTE_KEYS
        .iter()
