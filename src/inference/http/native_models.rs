...
pub(crate) fn after_cursor_start(
    routes: &[RouteSlug],
    cursor: Option<&str>,
    surface: Surface,
...
pub(crate) fn before_cursor_end(
    routes: &[RouteSlug],
    cursor: Option<&str>,
    surface: Surface,
    stale_message: &'static str,
...
pub(crate) fn supported_operations(
    runtime: &Bundle,
    slug: &RouteSlug,
    surface: Surface,
) -> Vec<OperationKind> {
...
mod tests {
    ...
    use crate::inference::http::native_models::*;
