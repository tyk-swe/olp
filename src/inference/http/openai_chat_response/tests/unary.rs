use crate::inference::http::openai_chat_response::tests::*;
...
fn a_real_gemini_response_reaches_an_openai_client() {
    let response: crate::protocols::gemini::dto::GenerateContentResponse =
        ...
        .unwrap();
    let events = crate::protocols::gemini::translate::response::decode(response.clone()).unwrap();
