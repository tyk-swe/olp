//! Converts HTTP admission and response completion into executor calls.
...
use crate::inference::execution::RoutedUnaryFinalizer;
...
pub(crate) fn authorize_principal<'a>(
    state: &GatewayState,
...
pub(crate) fn incompatible_result(operation: &'static str) -> InferenceError {
...
pub(crate) async fn execute_unary_result(
    state: &GatewayState,
    admission: &HttpRequestAdmission,
    operation: Operation,
...
mod tests {
    ...
    use crate::inference::http::execution::*;
