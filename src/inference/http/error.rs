...
///
/// `crate::inference` owns the error's classification, code, message, and retry
...
impl InferenceError {
    pub(crate) fn accounting_outcome(&self) -> crate::inference::lifecycle::RequestOutcome {
        crate::inference::lifecycle::RequestOutcome::failure(
    ...
    pub(crate) fn payload_too_large(code: &'static str) -> Self {
    ...
    pub(crate) fn resource_not_found(code: &'static str) -> Self {
    ...
    pub(crate) fn multipart_parser_timeout() -> Self {
    ...
    match kind {
        ...
        InferenceErrorKind::Canonical(class) => match class {
            ...
            other => {
                ...
                (status, crate::protocols::openai::error_type(other))
            }
        },
    }
}
...
pub(crate) fn insert_retry_after_header(response: &mut Response, retry_after: Option<Duration>) {
...
#[cfg(test)]
mod tests {
    use crate::inference::http::error::*;
