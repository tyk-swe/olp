...
use crate::inference::http::chat;
use crate::inference::http::endpoint_policy::registry::BodyAdmission;
...
use crate::inference::http::endpoint_policy::registry::Handler;
use crate::inference::http::gemini;
use crate::inference::http::media;
use crate::inference::http::openai_models;
use crate::inference::http::responses;
use crate::inference::http::videos;

pub(crate) fn router(limits: BodyLimits) -> Router<GatewayState> {
    ENDPOINTS
        .iter()
