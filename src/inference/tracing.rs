...
impl RequestTrace {
    ...
    #[must_use]
    pub(crate) const fn propagate_upstream(&self) -> bool {
        self.propagate_upstream
    }

    pub(crate) fn record_inference_context(
        &self,
        surface: Surface,
    ...
    pub(crate) fn attempt(&self, plan: &AttemptPlan) -> AttemptTrace {
        ...
        span.record(
            "olp.provider_revision",
            field::display(plan.provider_revision_id),
        );
        AttemptTrace {
            span,
            completed: false,
...
impl AttemptTrace {
    ...
    pub(crate) fn record_transport_failure(&mut self, error: &TransportError) {
        self.finish(
    ...
    pub(crate) fn finish(&mut self, outcome: &str, upstream_status_class: Option<&str>) {
...
mod tests {
    ...
    use crate::inference::tracing::ATTEMPT_ATTRIBUTE_KEYS;
    use crate::inference::tracing::REQUEST_ATTRIBUTE_KEYS;
    ...
    fn attempt_callsite_emits_only_allowlisted_attributes_and_no_content_events() {
        ...
        assert_eq!(capture.target, crate::inference::tracing::OTEL_TARGET);
    ...
    fn attempts_only_trace_does_not_rewrite_request_fields() {
        ...
        tracing::subscriber::with_default(subscriber, || {
            ...
            request.record_inference_context(
                ...
                &crate::ids::RouteSlug::parse("internal-route").unwrap(),
                uuid::Uuid::now_v7(),
                uuid::Uuid::now_v7(),
            );
