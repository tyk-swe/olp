...
use crate::usage::emitter::Event as MetadataEvent;
...
impl RequestLifecycle {
    ...
    pub(crate) fn finish_provider_attempt(&mut self, outcome: &RequestOutcome) {
...
pub(crate) struct RequestMetadataFinalizer(RequestLifecycle);

impl RequestMetadataFinalizer {
    pub(crate) fn finalize(mut self, outcome: &RequestOutcome) {
...
fn emit_request_metadata_event(emitter: Option<&Emitter>, input: RequestMetadataInput<'_>) {
