...
use crate::inference::failover::AttemptRecord;
use crate::inference::failover::BASE_RETRY_BACKOFF;
use crate::inference::failover::FailureHistory;
use crate::inference::failover::MAX_RETRY_AFTER_DELAY;
use crate::inference::failover::MAX_RETRY_BACKOFF;
use crate::inference::failover::attempt_billing_is_uncertain;
use crate::inference::failover::jitter_fraction;
use crate::inference::failover::plan_retry;
use crate::inference::failover::retry_backoff;
use crate::inference::failover::with_sole_target_retry;
...
fn history_after(
    ...
    error.upstream =
        crate::inference::transport::UpstreamSignal::from_status(429).with_retry_after(hint);
...
fn the_provider_retry_after_survives_into_the_retry_decision() {
    ...
    history.record_retry(
        TransportError {
            ...
            upstream: crate::inference::transport::UpstreamSignal::from_status(429)
...
mod execute {
    ...
    use crate::inference::failover::ExecutionFailure;
    use crate::inference::failover::ExecutionSuccess;
    use crate::inference::failover::MAX_RETRY_AFTER_DELAY;
    use crate::inference::failover::execute;
    use crate::inference::failover::tests::failure;
    use crate::inference::failover::tests::plan;
    use crate::inference::transport::AttemptFailureClass;
