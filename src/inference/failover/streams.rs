...
use crate::protocols::canonical::events::EventSequenceError;
...
pub(crate) fn canonical_event_protocol_error(
...
pub(crate) fn validated_event_stream(
...
pub(crate) fn circuit_accounted_event_stream_with_permit(
    events: ProviderEventStream,
    circuits: Breaker,
    target: TargetId,
    initial_failure: bool,
...
pub(crate) const fn canonical_error_circuit_class(
    class: ErrorClass,
