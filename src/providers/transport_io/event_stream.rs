...
impl DeadlineByteStream {
    pub(crate) fn new(
        ...
        let phase_deadline = first_byte_deadline.map_or_else(
            ...
            |configured| {
                crate::providers::transport_io::first_byte_deadline_within_attempt(
                    configured,
                    attempt_deadline,
                )
            },
