...
use crate::protocols::openai::audio::decode_transcription_response;
use crate::protocols::openai::audio::encode_speech;
use crate::protocols::openai::audio::encode_transcription;
use ::http::header;
...
fn require_transcription_text_content_type(
    ...
    if valid {
        ...
        Err(transport_error(
            crate::inference::transport::TransportPhase::FirstByte,
            crate::inference::transport::AttemptFailureClass::Protocol,
            false,
