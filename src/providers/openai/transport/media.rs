...
use crate::protocols::openai::images::decode_image_response;
...
pub(crate) async fn hydrate_chat_media(
...
pub(crate) async fn hydrate_responses_media(
...
impl Connector {
    pub(crate) async fn decode_image_result(
        &self,
        request: &ProviderRequest,
        mut wire: OpenAiImageResponse,
    ) -> Result<crate::protocols::canonical::results::ImagesResult, TransportError> {
...
pub(crate) async fn bounded_part(
    spool: &dyn crate::inference::transport::MediaSpool,
...
pub(crate) fn add_optional_text(
    form: multipart::Form,
    name: &'static str,
    value: Option<String>,
) -> multipart::Form {
...
pub(crate) fn add_image_edit_fields(
    mut form: multipart::Form,
...
pub(crate) async fn spool_response_body(
