...
use aws_sdk_bedrockruntime::types::CountTokensInput;
...
use crate::providers::bedrock::ConnectorConfig;
use crate::providers::bedrock::Credentials;
use crate::providers::bedrock::sdk_config;
use crate::providers::bedrock::translate::decode_converse;
use crate::providers::bedrock::translate::decode_stop_reason;
use crate::providers::bedrock::translate::decode_usage;
use crate::providers::bedrock::translate::encode_generation;
use crate::providers::bedrock::translate::encode_token_count;
use crate::providers::bedrock::translate::protocol_body_error;
use crate::providers::bedrock::translate::protocol_error;
use crate::providers::transport_common::inject_current_trace_context;
...
impl Connector {
    pub(crate) async fn new(config: ConnectorConfig, credentials: Credentials) -> Self {
