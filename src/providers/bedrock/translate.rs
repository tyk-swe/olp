...
use aws_sdk_bedrockruntime::types::ConverseOutput as BedrockConverseOutput;
use aws_sdk_bedrockruntime::types::ConverseTokensRequest;
...
use aws_sdk_bedrockruntime::types::ToolChoice as BedrockToolChoice;
...
fn validate_generation_parameters(request: &GenerationRequest) -> Result<(), TransportError> {
    reject_extensions(&request.extensions)?;
    if request
        .parameters
        .candidate_count
...
fn reject_extensions(
    extensions: &crate::protocols::canonical::requests::SourceExtensions,
...
pub(crate) fn protocol_error(message: impl Into<String>) -> TransportError {
    TransportError {
        ...
        class: crate::inference::transport::AttemptFailureClass::Protocol,
...
pub(crate) fn protocol_body_error(message: impl Into<String>) -> TransportError {
    TransportError {
        upstream: Default::default(),
        phase: crate::inference::transport::TransportPhase::Body,
        class: crate::inference::transport::AttemptFailureClass::Protocol,
