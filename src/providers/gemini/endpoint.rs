...
use crate::providers::endpoint::Error as CommonEndpointError;
...
impl Endpoint {
    ...
    pub(crate) fn generate_url(&self, upstream_model: &str, streaming: bool) -> Result<Url, Error> {
    ...
    pub(crate) fn count_tokens_url(&self, upstream_model: &str) -> Result<Url, Error> {
