...
use crate::providers::gemini::transport::operations::validate_operation;
use crate::providers::gemini::transport::*;
...
use crate::providers::mock_server::status_response;
    ...
    let mut contents = vec![Content {
        ...
        parts: vec![Part::InlineData(InlineDataPart {
            inline_data: Blob {
                ...
                data: crate::protocols::canonical::requests::inline_media_marker(&handle),
                extra: BTreeMap::new(),
            },
            extra: BTreeMap::new(),
        })],
