...
use crate::protocols::extensions::apply_response_extensions;
...
use crate::protocols::anthropic::dto::Usage;
use crate::protocols::anthropic::finish_reason;
...
pub(crate) fn take_cache_creation_input_tokens(
...
pub(crate) fn tool_input(arguments: &str) -> Result<Value, Error> {
...
mod tests {
    ...
    use crate::protocols::anthropic::client::*;
