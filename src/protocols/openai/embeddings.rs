...
use crate::protocols::canonical::results::EmbeddingVector;
use crate::protocols::canonical::results::EmbeddingsResult;
...
use crate::protocols::openai::extensions::apply_flat_extensions;
...
pub fn encode_embedding_response(
    ...
    crate::protocols::openai::extensions::apply_pointer_extensions(
        EmbeddingResponse {
            object: "list".into(),
            data,
