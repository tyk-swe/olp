...
use crate::protocols::canonical::requests::ContentPart as CanonicalContentPart;
use crate::protocols::canonical::requests::GenerationRequest;
use crate::protocols::canonical::requests::MediaSource;
use crate::protocols::canonical::requests::Message as CanonicalMessage;
use crate::protocols::canonical::requests::MessageRole;
use crate::protocols::canonical::requests::ResponseFormat as CanonicalResponseFormat;
use crate::protocols::canonical::requests::ToolChoice as CanonicalToolChoice;
use crate::protocols::canonical::requests::inline_media_marker;
use crate::protocols::canonical::requests::is_delivery_only_extension;

use crate::protocols::openai::chat::CompletionRequest;
use crate::protocols::openai::chat::ContentPart;
use crate::protocols::openai::chat::FunctionCall;
use crate::protocols::openai::chat::FunctionDefinition;
use crate::protocols::openai::chat::ImageUrl;
use crate::protocols::openai::chat::InputAudio;
use crate::protocols::openai::chat::JsonSchema;
use crate::protocols::openai::chat::Message;
use crate::protocols::openai::chat::MessageContent;
use crate::protocols::openai::chat::NamedFunction;
use crate::protocols::openai::chat::NamedToolChoice;
use crate::protocols::openai::chat::ResponseFormat;
use crate::protocols::openai::chat::Role;
use crate::protocols::openai::chat::StopSequences;
use crate::protocols::openai::chat::Tool;
use crate::protocols::openai::chat::ToolCall;
use crate::protocols::openai::chat::ToolChoice;
use crate::protocols::openai::extensions::unescape_json_pointer;
...
fn apply_extensions(
    ...
    {
        let segments = extension_path_segments(pointer)?;
...
fn extension_path_segments(pointer: &str) -> Result<Vec<String>, Error> {
    Ok(pointer
        .strip_prefix('/')
...
pub enum Error {
    #[error(transparent)]
    Extensions(#[from] crate::protocols::canonical::requests::ExtensionError),
