...
use crate::protocols::canonical::requests::ToolChoice;
...
use crate::protocols::openai::responses::errors::ResponsesCodecError;
use crate::protocols::openai::responses::helpers::collect_object_extra;
...
pub(crate) fn encode_response_content_part(
    part: &ContentPart,
) -> Result<Value, ResponsesCodecError> {
    encode_response_content_part_for_role(part, false)
}

pub(crate) fn encode_response_content_part_for_role(
    part: &ContentPart,
    assistant: bool,
) -> Result<Value, ResponsesCodecError> {
    match part {
...
pub(crate) fn decode_response_input(
    input: ResponseInput,
    extensions: &mut BTreeMap<String, Value>,
