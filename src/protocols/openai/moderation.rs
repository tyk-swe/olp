...
use crate::protocols::canonical::requests::ModerationRequest as CanonicalModerationRequest;
...
use crate::protocols::canonical::results::ModerationItem;
use crate::protocols::canonical::results::ModerationResult;
