...
use crate::protocols::canonical::requests::SpeechRequest as CanonicalSpeechRequest;
use crate::protocols::canonical::requests::TranscriptionRequest as CanonicalTranscriptionRequest;
use crate::protocols::canonical::results::SpeechResult;
use crate::protocols::canonical::results::TranscriptionResult;
use crate::protocols::canonical::results::TranscriptionSegment;
use serde::Deserialize;
use serde::Serialize;
use serde_json::Value;
use thiserror::Error;

use crate::protocols::openai::extensions::apply_pointer_extensions;
use crate::protocols::openai::extensions::collect_extra;
use crate::protocols::openai::media::BinaryMediaBody;
use crate::protocols::openai::media::BoundedMediaPart;
use crate::protocols::sse::DEFAULT_MAX_EVENT_BYTES;
use crate::protocols::sse::DecodeError;
use crate::protocols::sse::Decoder as SseDecoder;
...
pub fn encode_transcription(
    ...
    mut resolve_part: impl FnMut(
        &crate::protocols::canonical::requests::MediaHandle,
            ...
            match kind {
                ...
                "transcript.text.done" => {
                    ...
                    self.emit(
                        ...
                        Kind::Finish {
                            output_index: 0,
                            reason: crate::protocols::canonical::events::FinishReason::Stop,
                        },
                    );
