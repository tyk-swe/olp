...
use crate::http::cors::apply_gateway_cors;
use crate::http::problem::Problem;
use crate::http::request_admission::enforce_request_limits;
use crate::http::request_admission::public::PublicAdmissionMiddleware;
use crate::http::request_admission::public::admit_public_request;
...
fn mount_public_surfaces(
    ...
    if let Some(state) = gateway_state {
        ...
        let inference = Router::new()
            .merge(gateway::router(state.request_boundary.body_limits).with_state(state))
