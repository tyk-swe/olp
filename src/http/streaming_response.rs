...
use crate::protocols::sse::EncodeError;
...
use crate::inference::execution::RoutedStream;
...
mod tests {
    ...
    use crate::http::streaming_response::MAX_COALESCED_BYTES;
    use crate::http::streaming_response::StreamFinishOutcome;
    use crate::http::streaming_response::StreamSendFailure;
    use crate::http::streaming_response::TerminalFrames;
    use crate::http::streaming_response::encode_sse_frame;
    use crate::http::streaming_response::sse_stream_with_capacity;

    #[test]
    fn encode_sse_frame_preserves_event_id_and_data_line_bytes() {
        let encoded = encode_sse_frame(&crate::protocols::sse::Frame {
