...
use crate::protocols::openai::images::OpenAiImagePayload;
use crate::protocols::openai::images::encode_image_response;
use axum::body::Body;
use axum::body::Bytes;
...
mod tests {
    ...
    use crate::http::image_response::*;

    #[tokio::test]
    async fn image_json_is_incremental_valid_and_cleans_the_spool() {
        let spool = crate::media::spool::create_bounded_for_test().unwrap();
