...
impl PublicAuthRoute {
    ...
    pub(crate) const fn path(self) -> &'static str {
        match self {
            Self::FirstOwnerSetup => "/api/v3/setup",
            Self::PasswordLogin => "/api/v3/sessions",
            Self::InvitationAcceptance => "/api/v3/invitations/accept",
            Self::OidcLoginGet | Self::OidcLoginPost => "/api/v3/oidc/login",
        }
    }
