...
use crate::protocols::anthropic::dto::ContentBlock as AnthropicContentBlock;
use crate::protocols::anthropic::dto::Message as AnthropicMessage;
use crate::protocols::anthropic::dto::MessageContent as AnthropicMessageContent;
use crate::protocols::anthropic::dto::ToolResultContent;
use crate::protocols::canonical::requests::MediaHandle;
use crate::protocols::canonical::requests::inline_media_marker;
use crate::protocols::gemini::dto::Content as GeminiContent;
use crate::protocols::gemini::dto::CountTokensRequest as GeminiCountTokensRequest;
use crate::protocols::gemini::dto::GenerateContentRequest as GeminiGenerateContentRequest;
use crate::protocols::gemini::dto::Part as GeminiPart;
...
impl InlineMediaAdmission {
    fn new(state: &GatewayState) -> Self {
        Self {
            spool: state.request_boundary.inference.media_spool.clone(),
            limits: state.request_boundary.body_limits,
            handles: Vec::new(),
            total_bytes: 0,
        }
    }
...
mod tests {
    ...
    use crate::protocols::anthropic::translate::decode::request as decode_anthropic_request;
    ...
    use crate::protocols::gemini::translate::decode::request as decode_gemini_request;
    use crate::protocols::openai::chat::CompletionRequest;
