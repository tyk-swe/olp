...
const HTTP1_MAX_HEADERS: usize = crate::http::body_limits::MAX_HTTP_HEADER_COUNT;
const HTTP1_MAX_HEADER_BYTES: usize = crate::http::body_limits::MAX_HTTP_HEADER_BYTES;
