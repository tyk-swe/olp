...
//! and stream delivery live in `usage::ingestion` and `usage::queue`.
...
/// The bounded handoff from request completion to durable delivery.
///
...
mod tests {
    ...
    fn event() -> Event {
        ...
        Event {
            ...
            attempts: vec![RequestAttemptMetadata {
                ...
                latency_ms: 10,
                first_byte_ms: Some(3),
                usage: Some(crate::usage::emitter::RequestAttemptUsageMetadata {
                    observed: true,
                    complete: true,
    ...
    #[test]
    fn events_without_attempt_usage_are_rejected_by_ingestion() {
