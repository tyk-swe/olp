...
use crate::limits::distributed::DAY_MS;
use crate::limits::distributed::FIXED_WINDOW_MS;
use crate::limits::distributed::MAX_LUA_INTEGER;
use crate::limits::distributed::MAX_MONTH_MS;
use crate::limits::distributed::SCRIPT_RESPONSE_VERSION;
use redis::FromRedisValue;

pub(crate) enum ReservationScriptResult {
    Granted {
        window_id: i64,
...
pub(crate) enum CostReservationScriptResult {
    Granted,
    UninitializedState,
    Rejected {
        dimension: LimitDimension,
...
impl CostReservationScriptResult {
    pub(crate) fn parse_value(value: &redis::Value) -> Result<Self, LimitError> {
