...
Semantic smoke, race detection, and five deliberate runner-mutation tests passed in the isolated author worktree before timed capture. Baseline and replacement numeric status are pending until write-once artifacts appear. Do not interpret this document as a passing G6 report.
