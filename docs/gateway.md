...
| 503 | `authority_unavailable`, `request_admission_overloaded`, `distributed_limits_unavailable`, `upstream_unavailable`, `proxy_resource_exhausted`, `provider_resource_unavailable` | Stale authority, admission limit, limits that cannot be enforced, no eligible target, a proxy-local capacity bound outside the bounded-budget taxonomy, or a failure to durably record retained state. |
