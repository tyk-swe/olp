...
**Status:** Not started. **Prerequisites:** M3 complete.
...
- [ ] **Implement distributed rate and concurrency enforcement.**
...
- [ ] **Implement exact pricing and revision provenance.**
...
- [ ] **Persist terminal accounting without duplicate attribution.**
...
- [ ] **Restore recoverable metadata delivery and completeness.**
...
- [ ] **Restore UTC accrued-spend admission.**
...
- [ ] **Reconcile spend and recover worker leadership.**
...
- [ ] **Restore request history, analytics, and retention.**
...
- [ ] **Connect usage, history, pricing, and quota views.**
...
- [ ] **Qualify multi-process accounting and outage recovery.**
