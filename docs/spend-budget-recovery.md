...
[`internal/database/migrations/0001_access.sql`](../internal/database/migrations/0001_access.sql) and requires a fresh installation. Subsequent schema
changes live in [`internal/database/migrations/`](../internal/database/migrations/)
and are forward-only; see [Contributing](../CONTRIBUTING.md).
