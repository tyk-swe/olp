...
//! suites stay `#[ignore]`d and run via `make integration`
//! (`scripts/integration.sh`) with one database per test from
//! `olp::test_support`; the other modules run in every `make test`.
