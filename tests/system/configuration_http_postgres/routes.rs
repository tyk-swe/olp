...
pub(super) async fn exercise(
    ...
    let route_update = send(
        app,
        Method::PUT,
        &format!("/api/v3/route-drafts/{draft_id}"),
        Some(json!({
            "slug": "default",
            "operations": ["embeddings"],
    ...
    let simulation = send(
        app,
        Method::POST,
        &format!("/api/v3/route-drafts/{draft_id}/simulate"),
        Some(json!({
    ...
    let revisions = send(
        app,
        Method::GET,
        &format!("/api/v3/routes/{route_id}/revisions"),
        None,
        Some(cookie),
        None,
        None,
    ...
    let revision_page = send(
        app,
        Method::GET,
        &format!("/api/v3/routes/{route_id}/revisions?limit=1"),
        None,
        Some(cookie),
        None,
        None,
    ...
    let older_revisions = send(
        app,
        Method::GET,
        &format!("/api/v3/routes/{route_id}/revisions?limit=1&cursor={revision_cursor}"),
        None,
        Some(cookie),
        None,
        None,
    ...
    let revision_diff = send(
        ...
        Method::GET,
        &format!(
            "/api/v3/routes/{route_id}/revisions/diff?from={first_revision_id}&to={second_revision_id}"
        ),
        None,
        Some(cookie),
        None,
    ...
    let restored = send(
        app,
        Method::POST,
        &format!("/api/v3/routes/{route_id}/revisions/{first_revision_id}/restore-as-draft"),
        None,
        Some(cookie),
        Some(csrf),
    ...
    let deleted_restored = send(
        app,
        Method::DELETE,
        &format!("/api/v3/route-drafts/{restored_id}"),
        None,
        Some(cookie),
        Some(csrf),
        None,
