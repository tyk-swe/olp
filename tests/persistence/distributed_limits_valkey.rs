...
use olp::limits::admission::LimitDimension;
use olp::limits::admission::LimitError;
use olp::limits::admission::LimitRequest;
use olp::limits::distributed::DistributedLimitLease;
...
const RESERVE_SCRIPT: &str = include_str!("../../src/limits/reserve_limits.lua");
...
async fn release_twice(limiter: &DistributedLimiter, lease: &DistributedLimitLease) {
