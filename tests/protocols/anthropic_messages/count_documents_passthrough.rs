use olp::protocols::anthropic::client_stream::Encoder;
use olp::protocols::anthropic::count::decode_count_tokens_request;
use olp::protocols::anthropic::count::encode_count_tokens_result;
use olp::protocols::anthropic::dto::CountTokensRequest;
use olp::protocols::anthropic::dto::CountTokensResponse;
use olp::protocols::anthropic::stream::Decoder;
...
fn count_tokens_preserves_full_anthropic_semantics_and_encodes_native_result() {
    ...
    let preserved = &canonical.extensions.values
        [olp::protocols::anthropic::count::ANTHROPIC_COUNT_REQUEST_EXTENSION];
...
fn client_stream_encoder_emits_native_anthropic_sse_and_rejects_cross_surface_extensions() {
    ...
    assert!(
        encoder
            .push(olp::protocols::canonical::events::Event::new(
                0,
