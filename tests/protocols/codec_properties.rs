use olp::protocols::anthropic::dto::MessagesRequest;
use olp::protocols::anthropic::translate::decode::request as decode_anthropic_request;
use olp::protocols::anthropic::translate::encode::request as encode_anthropic_request;
use olp::protocols::canonical::requests::Operation;
use olp::protocols::gemini::dto::GenerateContentRequest;
use olp::protocols::gemini::translate::decode::request as decode_gemini_request;
use olp::protocols::gemini::translate::encode::request as encode_gemini_request;
use olp::protocols::openai::chat::CompletionRequest;
use olp::protocols::openai::chat::decode;
use olp::protocols::openai::chat::encode;
