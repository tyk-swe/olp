...
use olp::protocols::canonical::requests::ImageOperation;
use olp::protocols::canonical::requests::MediaHandle;
...
use olp::protocols::openai::audio::Decoder as AudioDecoder;
use olp::protocols::openai::audio::Encoder as AudioEncoder;
use olp::protocols::openai::audio::SpeechRequest;
use olp::protocols::openai::audio::TranscriptionRequest;
use olp::protocols::openai::audio::TranscriptionResponse;
use olp::protocols::openai::audio::decode_speech;
use olp::protocols::openai::audio::decode_transcription;
use olp::protocols::openai::audio::decode_transcription_response;
use olp::protocols::openai::audio::encode_transcription;
use olp::protocols::openai::audio::encode_transcription_response;
use olp::protocols::openai::embeddings::EmbeddingRequest;
use olp::protocols::openai::embeddings::EmbeddingResponse;
use olp::protocols::openai::embeddings::decode_embedding_request;
use olp::protocols::openai::embeddings::decode_embedding_response;
use olp::protocols::openai::embeddings::encode_embedding_request;
use olp::protocols::openai::embeddings::encode_embedding_response;
use olp::protocols::openai::images::ImageStreamOperation;
use olp::protocols::openai::images::ImageStreamUpdate;
use olp::protocols::openai::images::OpenAiImageEditRequest;
use olp::protocols::openai::images::OpenAiImageGenerationRequest;
use olp::protocols::openai::images::OpenAiImagePayload;
use olp::protocols::openai::images::OpenAiImageResponse;
use olp::protocols::openai::images::OpenAiImageStreamEvent;
use olp::protocols::openai::images::decode_image_edit;
use olp::protocols::openai::images::decode_image_generation;
use olp::protocols::openai::images::decode_image_response;
use olp::protocols::openai::images::decode_image_stream_event;
use olp::protocols::openai::images::encode_image_generation;
use olp::protocols::openai::images::encode_image_response;
use olp::protocols::openai::images::encode_image_stream_update;
use olp::protocols::openai::media::BoundedMediaPart;
use olp::protocols::openai::moderation::Request;
use olp::protocols::openai::moderation::Response;
use olp::protocols::openai::moderation::decode;
use olp::protocols::openai::moderation::decode_response;
use olp::protocols::openai::moderation::encode;
use olp::protocols::openai::moderation::encode_response;
use olp::protocols::openai::responses::request::encode_response_create;
use olp::protocols::openai::responses::token_count::ResponseInputTokensRequest;
use olp::protocols::openai::responses::token_count::ResponseInputTokensResponse;
use olp::protocols::openai::responses::token_count::decode_response_input_tokens;
use olp::protocols::openai::responses::token_count::decode_response_input_tokens_result;
use olp::protocols::openai::responses::token_count::encode_response_input_tokens;
use olp::protocols::openai::video::OpenAiVideoCreateRequest;
use olp::protocols::openai::video::OpenAiVideoDeleteResponse;
use olp::protocols::openai::video::OpenAiVideoListQuery;
use olp::protocols::openai::video::OpenAiVideoListResponse;
use olp::protocols::openai::video::OpenAiVideoObject;
use olp::protocols::openai::video::decode_video_create;
use olp::protocols::openai::video::decode_video_delete_response;
use olp::protocols::openai::video::decode_video_list;
use olp::protocols::openai::video::decode_video_list_response;
use olp::protocols::openai::video::encode_video_delete_response;
use olp::protocols::openai::video::encode_video_list_response;
use serde_json::json;

use super::common::media_part;
use super::common::video_object;
...
fn media_stream_updates_are_bounded_handles_and_fragment_safe() {
    ...
    assert!(matches!(
        ...
        ImageStreamUpdate::Partial {
            index: 2,
            image: olp::protocols::canonical::results::ImageArtifact {
...
fn cross_protocol_extensions_fail_closed() {
    let request = GenerationRequest {
        ...
        messages: vec![Message {
            ...
            content: vec![olp::protocols::canonical::requests::ContentPart::Text {
                text: "hello".into(),
            }],
            name: None,
            tool_call_id: None,
