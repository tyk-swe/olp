<script lang="ts">
  import type { OidcIdentityList } from '$lib/features/access/profile/api';
  import { formatDate } from '$lib/format';
  import type { PendingIdentityAction } from '$lib/features/access/profile/recentAuthentication';
