...
mod tests {
    ...
    fn fallback_replaces_every_historical_api_key_security_field() {
        ...
        let historical_key = ApiKey {
            ...
            owner: olp_domain::ApiKeyOwner::User(olp_domain::UserId::new()),
            team_id: None,
            project_id: None,
        ...
        let current_key = ApiKey {
            ...
            owner: olp_domain::ApiKeyOwner::ServiceAccount(olp_domain::ServiceAccountId::new()),
            team_id: Some(olp_domain::TeamId::new()),
            project_id: Some(olp_domain::ProjectId::new()),
            status: ApiKeyStatus::Active,
