...
impl PgStore {
    pub(super) async fn usage_range_coverage(
        ...
        let excluded = super::super::cursor::checked_u64(
...
pub(in crate::operations) fn floor_usage_hour(value: DateTime<Utc>) -> DateTime<Utc> {
...
pub(in crate::operations) fn ceil_usage_hour(value: DateTime<Utc>) -> DateTime<Utc> {
