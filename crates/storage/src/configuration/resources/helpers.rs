...
pub(super) fn capability_from_row(row: &PgRow) -> Result<CapabilityRecord, ConfigurationError> {
    Ok(CapabilityRecord {
        operation: row
...
pub(super) fn configuration_count(row: &PgRow, column: &str) -> Result<u64, ConfigurationError> {
