        ...
        let pricing = sqlx::query!(
            "SELECT selected.pricing_revision_id AS \"pricing_revision_id?\", \
                    ...
                    selected.pricing_revision_id IS NOT NULL \
                      ...
                      AND ($9::bigint IS NULL OR COALESCE(selected.cached_input_per_million, selected.input_per_million) IS NOT NULL) \
                      AS \"pricing_complete!\", \
                    CASE WHEN $8::boolean \
                         ...
                         THEN (COALESCE($5::numeric * selected.input_per_million / 1000000, 0) \
                             ...
                             + COALESCE($9::bigint * COALESCE(selected.cached_input_per_million, selected.input_per_million) / 1000000, 0) \
