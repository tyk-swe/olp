...
pub(in crate::inference) struct CircuitPermit {
...
impl Breaker {
    ...
    pub(in crate::inference) fn try_acquire_permit(
        &self,
        target: TargetId,
    ...
    pub(in crate::inference) fn abandon_probe(&self, target: TargetId, permit: CircuitPermit) {
