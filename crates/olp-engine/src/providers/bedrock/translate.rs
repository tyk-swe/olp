...
pub(in crate::providers) struct EncodedConverse {
...
pub(in crate::providers) fn encode_generation(
...
pub(in crate::providers) fn encode_token_count(
...
pub(in crate::providers) fn decode_stop_reason(reason: &StopReason) -> FinishReason {
    match reason {
