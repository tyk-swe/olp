...
use crate::domain::{DiscoveredProviderModel, ProviderTransport};

use crate::providers::anthropic::{AnthropicApiKey, AnthropicConnector};
use crate::providers::azure_openai::{AzureOpenAiApiKey, AzureOpenAiConnector};
use crate::providers::bedrock::{
    BedrockConnector, BedrockCredentials, StaticCredentials as BedrockStaticCredentials,
};
use crate::providers::gemini::{GeminiApiKey, GeminiConnector};
use crate::providers::openai::{OpenAiApiKey, OpenAiConnector};
use crate::providers::vertex::VertexConnector;
...
pub struct ProviderFacade {
    pub(super) kind: crate::domain::ProviderKind,
...
impl ProviderFacade {
    ...
    pub(in crate::providers) fn from_local_vertex(connector: VertexConnector) -> Self {
        Self {
            kind: crate::domain::ProviderKind::VertexAi,
    ...
    pub(in crate::providers) fn from_local_bedrock(connector: BedrockConnector) -> Self {
        Self {
            kind: crate::domain::ProviderKind::Bedrock,
