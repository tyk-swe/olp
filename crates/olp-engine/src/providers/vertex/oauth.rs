...
pub(in crate::providers) struct ApplicationDefaultTokenProvider {
    credentials: AccessTokenCredentials,
}

impl ApplicationDefaultTokenProvider {
    pub(in crate::providers) const fn new(credentials: AccessTokenCredentials) -> Self {
        Self { credentials }
    }
}
...
#[derive(Deserialize)]
pub(in crate::providers) struct ServiceAccountCredential {
    #[serde(rename = "type")]
...
pub(in crate::providers) struct ServiceAccountTokenProvider {
...
impl ServiceAccountTokenProvider {
    pub(in crate::providers) fn from_json(value: &str) -> Result<Self, ServiceAccountError> {
    ...
    #[cfg(test)]
    pub(in crate::providers) fn from_json_for_test(
        value: &str,
    ) -> Result<Self, ServiceAccountError> {
