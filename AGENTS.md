...
OpenLLMProxy combines a Go gateway with a client-only SvelteKit console. Independent conformance inputs live in `tests/fixtures/reference-inventory.json` and `tests/release-behaviors.json`; `docs/roadmap/README.md` retains dated qualification provenance.
