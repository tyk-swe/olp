...
func TestParseReconciliation(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"refused arguments", reply(int64(1), int64(-1), "invalid_arguments", int64(0), int64(0)), false, false, ErrUnexpectedResponse},
		{"refusal with a count", reply(int64(1), int64(-1), "invalid_arguments", int64(1), int64(0)), false, false, ErrUnexpectedResponse},
