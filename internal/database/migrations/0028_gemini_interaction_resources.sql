...
ALTER TABLE olp.provider_resources DROP CONSTRAINT provider_resources_kind_check;
ALTER TABLE olp.provider_resources ADD CONSTRAINT provider_resources_kind_check
    CHECK (kind IN ('file', 'batch', 'response', 'continuation', 'strict_response', 'interaction'));

ALTER TABLE olp.provider_resources ADD CONSTRAINT provider_resources_interaction_contract_check
