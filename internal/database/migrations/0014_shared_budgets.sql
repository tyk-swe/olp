...
ALTER TABLE olp.api_keys ADD COLUMN budget_group_id uuid REFERENCES olp.budget_groups;
...
ALTER TABLE olp.requests ADD COLUMN budget_group_id uuid REFERENCES olp.budget_groups;
ALTER TABLE olp.attempt_usage_facts ADD COLUMN budget_group_id uuid REFERENCES olp.budget_groups;
ALTER TABLE olp.attempt_usage_hourly ADD COLUMN budget_group_id uuid REFERENCES olp.budget_groups;
ALTER TABLE olp.attempt_usage_hourly DROP CONSTRAINT attempt_usage_hourly_dimensions_key;
ALTER TABLE olp.attempt_usage_hourly ADD CONSTRAINT attempt_usage_hourly_dimensions_key
